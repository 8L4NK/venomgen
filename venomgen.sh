#!/bin/bash
# VenomGen v1.0: Payload Generator and WAN Listener 
# Coded by: @thelinuxchoice
# Github: https://github.com/thelinuxchoice/venomgen

trap 'printf "\n";stop' 2

banner() {

printf "\e[1;77m __     __                          \e[0m\e[1;92m____             \e[0m\n"
printf "\e[1;77m \ \   / /__ _ __   ___  _ __ ___  \e[0m\e[1;92m/ ___| ___ _ __   \e[0m\n"
printf "\e[1;77m  \ \ / / _ \ '_ \ / _ \| '_ \` _ \ \e[0m\e[1;92m |  _ / _ \ '_ \  \e[0m\n"
printf "\e[1;77m   \ V /  __/ | | | (_) | | | | | |\e[0m\e[1;92m |_| |  __/ | | | \e[0m\n"
...
printf "                           \e[1;77mby @thelinuxchoice\e[0m\n"
printf "\n"
}
